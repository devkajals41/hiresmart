def generate_feedback(parsed_resume: dict, scores: dict):
    ...
    if section_scores["contact"] == 10:
        ...
        weaknesses.append("Complete your contact details.")

    # Education
    if section_scores["education"] >= 12:
        strengths.append("Well-structured education section.")
    else:
        weaknesses.append("Improve education details.")

    # Experience
    if section_scores["experience"] >= 15:
        strengths.append("Strong experience section.")
    else:
    ...
    if section_scores["projects"] >= 15:
        ...
        weaknesses.append("Improve project descriptions.")
    ...
    if section_scores["certifications"] == 0:
        weaknesses.append("Consider adding certifications.")

    # Achievements
    if section_scores["achievements"] == 0:
        weaknesses.append("Highlight achievements.")

    # Positions
    if section_scores["positions"] == 0:
        weaknesses.append("Include leadership or responsibility roles.")
