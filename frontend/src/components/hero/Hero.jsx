        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.22fr] lg:gap-6">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="inline-flex w-fit items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-emerald-800 shadow-sm">
              <Sparkles size={12} className="text-emerald-700 fill-emerald-700/10" />
            ...
            <p className="mt-4 max-w-lg text-sm lg:text-base leading-6 lg:leading-7 text-slate-500 font-medium">
              Upload your resume once. HireSmart analyzes, optimizes and prepares you for interviews with personalized guidance from AI.
            </p>
            ...
            <div className="mt-8 flex items-center gap-x-3 lg:gap-x-4 whitespace-nowrap overflow-x-auto scrollbar-none py-1">
              ...
              <div className="flex items-center gap-1 text-[11px] lg:text-xs font-semibold text-slate-500 shrink-0">
                <MessageCircle size={13} className="text-emerald-700 shrink-0" />
              ...
              <div className="flex gap-5">
                ...
                <div className="hidden sm:flex flex-col items-center gap-4.5 border-r border-slate-100 pr-4 pt-1 shrink-0">
                  ...
                  {[
                    ...
                    <button key={idx} className="flex h-8.5 w-8.5 items-center justify-center rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer">
                      <item.Icon size={16} />
                    </button>
                  ))}
                </div>
                ...
                <div className="flex-1 flex flex-col gap-4.5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <button className="flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-xs self-start sm:self-auto cursor-pointer">
                      <Upload size={14} className="text-emerald-700 stroke-[2.5]" />
                      Upload New Resume
                    </button>
                  </div>
                  ...
                  <div className="grid gap-4.5">
                        ...
                        <div className="flex h-full flex-col items-center justify-center py-0.5">
                          ...
                          <div className="relative mt-2 flex items-center justify-center">
                            ...
                            <div className="absolute flex flex-col items-center justify-center">
                              <span className="text-xl font-extrabold text-slate-800 leading-none">91%</span>
                              <span className="text-[8px] font-bold text-emerald-600 uppercase tracking-wider mt-0.5">Excellent</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {[
                        { value: "84%", title: "Skill Match", status: "Good Match", sparkPath: "M3 15 C10 13, 18 5, 30 10 S42 2, 50 4" },
                        { value: "89%", title: "Interview Ready", status: "Very Good", sparkPath: "M3 18 C10 15, 18 10, 30 8 S42 2, 50 3" },
                        { value: "92%", title: "Overall Strength", status: "Excellent", sparkPath: "M3 16 C10 18, 18 8, 30 11 S42 3, 50 4" },
                        ...
                        >
                          ...
                          <div className="w-10 h-6 flex items-center shrink-0">
                            <svg className="w-full h-full text-emerald-500" viewBox="0 0 55 20" fill="none">
                              <path
                                d={sparkPath}
                                stroke="currentColor"
                                strokeWidth="2"
                    ...
                    <div className="grid grid-cols-[1.5fr_1fr] gap-4 items-end">
                      ...
                      <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-[0_4px_20px_rgba(15,23,42,.01)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(15,23,42,.03)]">
                        ...
                        <p className="mt-1.5 text-xs font-semibold text-slate-500 leading-relaxed">
                          Add more measurable achievements in your work experience.
                        </p>
        ...
        <div className="mt-10 rounded-[20px] border border-slate-100 bg-white p-4.5 shadow-[0_10px_40px_rgba(15,23,42,0.02)]">
          <div className="grid grid-cols-2 gap-y-4 gap-x-3 sm:grid-cols-3 lg:grid-cols-5 lg:gap-2">
            ...
            <div className="flex items-center gap-2.5">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-700">
                <svg className="h-5 w-5 stroke-[2]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <polygon points="12 8 13.5 11 16.5 11.5 14 13.5 15 16.5 12 15 9 16.5 10 13.5 7.5 11.5 10.5 11" fill="currentColor" className="text-emerald-700/20" />
                </svg>
              </div>
              <div>
                <div className="text-base font-bold text-slate-800 leading-tight">95%</div>
                <div className="text-[11px] text-slate-400 font-semibold leading-tight mt-0.5">Resume Parsing Accuracy</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-base font-bold text-slate-800 leading-tight">500+</div>
                <div className="text-[11px] text-slate-400 font-semibold leading-tight mt-0.5">Interview Questions Generated</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-base font-bold text-slate-800 leading-tight">50+</div>
                <div className="text-[11px] text-slate-400 font-semibold leading-tight mt-0.5">Skills Extracted Using NLP</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-base font-bold text-slate-800 leading-tight">5</div>
                <div className="text-[11px] text-slate-400 font-semibold leading-tight mt-0.5">AI Modules Integrated</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-base font-bold text-[#0F172A] leading-tight">End-to-End</div>
                <div className="text-[11px] text-slate-400 font-semibold leading-tight mt-0.5">Career Preparation</div>
              </div>
            </div>
